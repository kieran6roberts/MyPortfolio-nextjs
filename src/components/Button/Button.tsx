...
export default function Button({ link, children, color }: ButtonProps): React.ReactElement {
    return (
        <a href={link}
        className={`group ${color} w-44 flex align-items whitespace-nowrap text-xxs font-bold uppercase py-2 px-3 border-2 border-pri cursor-pointer transition duration-50 ease-in hover:bg-pri`} >
