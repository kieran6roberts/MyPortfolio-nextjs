...
export default function Card({ items, header }: CardProps): React.ReactElement {
    ...
    return (
        <div className="flex flex-col lg:flex-1 mx-2">
            <p className="text-md uppercase font-bold text-sec text-center pt-12 pb-8">
                {header}
            </p>
            <ul className="flex bg-light flex-col justify-start h-full items-center text-xs text-gray-600 pt-4">
